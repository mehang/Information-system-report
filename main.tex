...
\renewcommand{\baselinestretch}{1.5} \renewcommand{\contentsname}{\fontsize{14pt}{0pt}\selectfont TABLE OF CONTENTS}
...
Introduced in 2005, Hadoop has proved to be a ground-breaking technology that has changed the way 
we handle Big amounts of Data.\\
\\
In this case study, we go over the basics of Hadoop and the main technologies that constitute it: especially
Hadoop Distributed File System (HDFS) and MapReduce.\\
\\
We then point out the reasons as to why Hadoop is able to provide scalability to systems that use it. 
We found it to be related to other features of Hadoop such as Cost-Effectiveness, Flexibility, and Fault-tolerance.
We also learned about the problems in Hadoop 1.x that hampered scalability of Hadoop Systems, and which were 
subsequently addressed in Hadoop 2.x.\\
\\
We also give our brief findings on the possible future of Hadoop in light of the growth of Hadoop into an ecosystem
instead of a particular technology.\\
\\
Keywords: \textit{Hadoop, scalability, Distributed System, MapReduce.}
\clearpage
\thispagestyle{fancy}
...
\begin{thebibliography}{1}
        ...
        \bibitem{Zaharia2010}
                Zaharia, Matei, et al. 
                \emph{Spark: cluster computing with working sets.} 
                HotCloud 10 (2010): 10-10.
